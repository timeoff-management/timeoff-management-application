...
router.get(/email/, function(req, res){
    ...
    var user_id = typeof req.query.user_id !== 'undefined' && validator.toInt(req.query.user_id),
        start_date = typeof req.query.start_date !== 'undefined' && validator.trim(req.query.start_date),
        end_date = typeof req.query.end_date !== 'undefined' && validator.trim(req.query.end_date),
        page = (typeof req.query.page !== 'undefined' && validator.toInt(req.query.page)) || 1,
