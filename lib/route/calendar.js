  ...
  Promise.join(
    ...
    function(calendar, company, user, supervisors, user_allowance){
      ...
      res.render('calendar', {
        ...
        number_of_days_available_in_allowance : user_allowance.number_of_days_available_in_allowance,
        total_number_of_days_in_allowance     : user_allowance.total_number_of_days_in_allowance,
      });
    }
  );
