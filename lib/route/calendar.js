...
router.get('/teamview/', async (req, res) => {
  ...
  const base_date = req.query.date && validator.toDate(req.query.date)
    ...
    (team_view_details, company) => {
      ...
      team_view
        ...
        .then(team_view_details => res.render('team_view', {
            ...
            users_and_leaves_by_departments: grouped_mode !== null ? groupUsersOnTeamViewByDepartments(team_view_details.users_and_leaves) : null
          })
        );
    })
    .catch(error => {
