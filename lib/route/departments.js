...
function promise_to_extract_company_and_department(department_id, params, session, req, only_active = true) {
    var company;
...
router.post('/departments/edit/:department_id/', function (req, res) {
  ...
  var only_active = !req.body.remove_supervisor_id
    ...
    Promise.try(function () {
        return promise_to_extract_company_and_department(department_id, req.body, req.session, req, only_active);
    })
        .then(function (result) {
