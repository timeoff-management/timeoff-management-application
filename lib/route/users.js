...
function get_and_validate_user_parameters(args) {
  ...
  var name = req.body["name"] && validator.trim(req.body["name"]),
    ...
    email =
      req.body["email_address"] && validator.trim(req.body["email_address"]),
    department_id =
      req.body["department"] && validator.trim(req.body["department"]),
    start_date =
      req.body["start_date"] && validator.trim(req.body["start_date"]),
    end_date = req.body["end_date"] && validator.trim(req.body["end_date"]),
    adjustment =
      req.body["adjustment"] && validator.trim(req.body["adjustment"]),
    password =
      req.body["password_one"] && validator.trim(req.body["password_one"]),
    password_confirm =
      req.body["password_confirm"] &&
      validator.trim(req.body["password_confirm"]),
    admin =
      (req.body["admin"] && validator.toBoolean(req.body["admin"])) || false,
    auto_approve =
      (req.body["auto_approve"] &&
        validator.toBoolean(req.body["auto_approve"])) ||
      false;
