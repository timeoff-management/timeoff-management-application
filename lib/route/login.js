...
module.exports = function(passport) {
    ...
    req.app.get('db_model').User.find_by_email(email)
      ...
      .catch(function(error){
        ...
        if (error.do_not_report ){
          ...
          console.error('An error occurred while submittin forgot password form: ' + error, error.stack);
  ...
  router.post('/reset-password/', function(req, res){
    ...
    router.post('/import-company/', upload.single('company_dump'), function (req, res) {
      ...
      .catch(function(error){
          req.session.flash_error('Failed to import company, due to error: ' + error, error.stack);
        res.redirect_with_session('/import-company/');
      });
