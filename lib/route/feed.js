                ...
                .then((days) => {
                    ...
                    days.forEach(function (day) {
                        ...
                        cal.createEvent({
                            ...
                            allDay: true,
                            description: new Buffer(JSON.stringify({years: day.years, name: day.user.full_name()})).toString('base64')
                        });
                    });
        ...
        .then(function (days) {
            ...
            days.forEach(function (day) {
                ...
                cal.createEvent({
                    ...
                    description: new Buffer(JSON.stringify({name: day.user.full_name(), leaveTypeId: day.leave_obj.leaveTypeId })).toString('base64')
