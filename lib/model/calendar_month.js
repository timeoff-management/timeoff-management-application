        ...
        args.leave_days.forEach(function(day){
            ...
            if ( ! map[attribute] ) {
                ...
                if (day.is_all_day_leave()){
                    ...
                    if ( map[attribute].is_morning_leave()) {
                      map[attribute].afternoon_leave_type_id = day.afternoon_leave_type_id;
                    }
                    if ( map[attribute].is_afternoon_leave() ) {
    ...
    for( var i=1; i<=self.how_many_days(); i++){
        ...
        if ( self.is_weekend(i) ) {
            ...
            if ( self.is_leave_morning(i) ) {
              ...
              day.leave_color_class = morning_leave_type_id && self._leave_types_map[ morning_leave_type_id ]
            ...
            if ( self.is_leave_afternoon(i) ) {
              ...
              day.leave_color_class = afternoon_leave_type_id && self._leave_types_map[ afternoon_leave_type_id ]
