      ...
      if (!map[attribute]) {
        ...
        if (day.is_all_day_leave()) {
          ...
          if (day.is_afternoon_leave()) {
            map[attribute].afternoon_leave_type_id =
              day.afternoon_leave_type_id;
          }
...
CalendarMonth.prototype.is_bank_holiday = function (day) {
  return (
    this._bank_holidays &&
    this._bank_holidays.hasOwnProperty(
    ...
    if (self.is_weekend(i)) {
      ...
      if (self.is_leave_morning(i)) {
        ...
        leaveLabelForDay.morning =
          self._leave_types_map[morning_leave_type_id].name || "morning";
      }
      ...
      if (self.is_leave_afternoon(i)) {
        ...
        leaveLabelForDay.afternoon =
          self._leave_types_map[afternoon_leave_type_id].name || "afternoon";
      }
...
CalendarMonth.prototype.as_for_team_view = function () {
  ...
  var days = _.filter(_.flatten(for_calendar_structure.weeks), function (day) {
    return !!day.val;
  });
