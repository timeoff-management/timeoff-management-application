...
LeaveDay.prototype.is_morning_leave = function(){
  return this.day_part === this.sequelize.models.Leave.leave_day_part_morning();
};

LeaveDay.prototype.is_afternoon_leave = function(){
  return this.day_part === this.sequelize.models.Leave.leave_day_part_afternoon();
};
