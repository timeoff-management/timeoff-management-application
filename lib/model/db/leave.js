    ...
    var Leave = sequelize.define("Leave", {
        ...
        classMethods : {
            ...
            create_new_leave : function(args){
              ...
              .then(function(){
                // TODO replace it with simply reusing boss_id of department
...
promise_to_revoke : function(){
  ...
  return self.getUser({
    ...
    .then(function(user){
      ...
      // TODO this needs to be populated based on actual user who performs
      // the "revoke" action.
      // In fact it needs to be passed as a parameter.
      // And if it is an autoapprove case set it as department's boss
