...
//console.log('>>> 11'+ ( leave_request.is_within_one_day() ? 'Y':'N'  ) );
//console.log('>>> 22'+ ( leave_request.does_fit_with_leave_day( _.first(this.days) ) ? 'Y':'N'  ) );
//console.log('>>> 33'+ ( leave_request.does_fit_with_leave_day( _.last(this.days) ) ? 'Y':'N'  ) );

                    console.log('>>>> 1');
                    console.log('>>>> LR: '+JSON.stringify(leave_request.as_data_object()));
                    console.log('>>>> S'+JSON.stringify( _.first(this.days) ));
                    console.log('>>>> E'+JSON.stringify( _.last(this.days) ));
                    return true;
                }
