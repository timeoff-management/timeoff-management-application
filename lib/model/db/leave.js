...
module.exports = function(sequelize, DataTypes) {
  ...
  Object.assign(Leave, {
    ...
    create_new_leave: function(args) {
      ...
      _.each(["for_employee", "of_type", "with_parameters"], function(
        property
      ) {
      ...
      leave_days =
        _.filter(
          _.map(this.get_days(), function(leave_day) {
            ...
            if (year && year.year() !== moment.utc(leave_day.date).year())
              return
