...
function get_instance_methods(sequelize) {
  ...
  return {
     ...
     * DEPRECATED
     *
     * Consider using non-blocking version:
     *  promise_number_of_days_available_in_allowance
     *
     * */
    calculate_number_of_days_available_in_allowance : function(year, deprecate){

      if ( deprecate !== 'deprecated' ) {
        throw new Error('calculate_number_of_days_available_in_allowance is deprecated!');
      }
    ...
    /*
     * Async version of getting number of days remaining in allowance for
     * current user
     *
     * */
    promise_number_of_days_available_in_allowance : function(year) {
      ...
      return Promise.resolve(
        self.calculate_number_of_days_available_in_allowance(year, 'deprecated')
      );
    },
