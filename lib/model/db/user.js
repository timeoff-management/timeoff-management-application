...
console.log('>>>> here we are');
                    ...
                    if (
                        new_leave_attributes.is_within_one_day()
                          &&
                        (
                            new_leave_attributes.does_fit_with_leave_day(
                                _.last(overlapping_leave.days)
                            )
                            ||
                            new_leave_attributes.does_fit_with_leave_day(
                                _.first(overlapping_leave.days)
                            )
                        )
                      ) {
                        return Promise.resolve(1);
...
console.log('>>>> here we are 11111');
                    ...
                    if (
                        ! new_leave_attributes.is_within_one_day()
                          &&
                        (
                            new_leave_attributes.does_fit_with_leave_day_at_start(
                                 _.last(overlapping_leave.days)
                            )
                            ||
                            new_leave_attributes.does_fit_with_leave_day_at_end(
                                 _.first(overlapping_leave.days)
                            )
                        )
                    ) {
