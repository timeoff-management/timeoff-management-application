  ...
  return {
    ...
    promise_supervised_users : function () {
      ...
      return self
        ...
        .then(departments => {
            return self.sequelize.models.User.findAll({where: {DepartmentId: departments.map(d => d.id)}});
        })
    },
    ...
    get_reset_password_token : function(){
      var self = this;
        ...
        return new Buffer(self.email + ' ' + this.sequelize.models.User.hashify_password(self.password)).toString('base64');
    },
