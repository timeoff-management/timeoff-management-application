  ...
  var User = sequelize.define(
    "User",
    {
      ...
      auto_approve: {
        ...
        defaultValue: false,
        comment:
          "Indicate if leave request from current employee are auto approveed"
      },
      start_date: {
        type: DataTypes.DATE,
        allowNull: false,
  ...
  function get_instance_methods(sequelize) {
    return {
          ...
          // Obtain departments current user supervises as secondary supervisor
            ...
            .then(department_ids => {
              ...
              return sequelize.models.Department.scope(
                ...
                where: {
                  [Op.or]: [{ id: department_ids }, { bossId: self.id }]
                }
              });
            })
        );
      ...
      get_reset_password_token: function() {
        ...
        return new Buffer(
          self.email + " " + sequelize.models.User.hashify_password(self.password)
        ).toString("base64");
      },
      ...
      promise_schedule_I_obey: function() {
        ...
        return self.sequelize.models.Schedule.findAll({
          where: {
            [Op.or]: [{ user_id: self.id }, { company_id: self.companyId }]
          }
          ...
          if (schedules.length === 2) {
            return Promise.resolve(
              _.findOne(schedules, function(sch) {
