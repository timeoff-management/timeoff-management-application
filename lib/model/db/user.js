...
promise_my_approved_leaves : function() {
...
calculate_number_of_days_taken_from_allowence : function(){
  var all_deducable_days = _.flatten(
    _.map(
      _.filter(
        this.my_leaves,
        function (leave){ return leave.is_approved_leave() }
      ),
      function(leave){ return leave.get_deducted_days() }
    ),
    true // shallow
  ) || [];

  return all_deducable_days.length;
},

calculate_number_of_days_available_in_allowence : function(){
  return this.calculate_total_number_of_days_n_allowence()
    - this.calculate_number_of_days_taken_from_allowence();
},

calculate_total_number_of_days_n_allowence : function() {
  // TODO subtract/add additional days
  return this.department.allowence;
},

reload_with_leave_details : function(){
