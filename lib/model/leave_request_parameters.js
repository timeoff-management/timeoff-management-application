...
//  console.log('---------');
//  console.log('>>>>'+moment(leave_day.date).format('YYYY-MM-DD'));
//  console.log('>>>>'+moment(this[point_name]).format('YYYY-MM-DD'));
//  console.log('>>>>'+ leave_day.is_all_day_leave() +' '+ leave_day.day_part );
//  console.log('>>>>'+leave_day.day_part +'   '+ this[point_name+'_part']);

    var return_val = moment(leave_day.date).format('YYYY-MM-DD')
          ===
...
//    console.log('result is: '+(return_val ? 'TRUE' : 'FALSE'));
