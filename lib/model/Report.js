...
const getUsersWithLeaves = ({
  ...
  result = result.then(users => Promise.map(users, user => user.reload_with_leave_details({holiday_year_start_month :company.holiday_year_start_month}), { concurrency : 10}));
